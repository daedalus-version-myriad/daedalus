import { ButtonStyle, ChannelType, ComponentType, escapeMarkdown, Role, SnowflakeUtil, type APIEmbed, type EmbedData } from "discord.js";
import { hex } from "wcag-contrast";
import { trpc } from "../../api/index.js";
import { checkPermissions, Commands, defer, expand, fetchCaller, getColor, template, timeinfo, timestamp } from "../../bot-utils/index.js";
    ...
    x
        ...
        .slash((x) =>
            x
                ...
                .fn(async ({ _ }) => ({
                    content: "If you are seeing blank messages from this bot, go to **User Settings > Text & Images** and enable **Embeds and Link Previews**.",
                    embeds: [
                        {
                            title: "Daedalus Help",
